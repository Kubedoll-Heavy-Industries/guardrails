...
from pydash import camel_case, is_equal, snake_case, start_case, uniq_with, upper_first
...
def gen_string(schema: dict[str, Any], *, property_name: str | None = None) -> str:
...
def gen_array(schema: dict[str, Any], *, property_name: str | None = None) -> list[Any]:
    """
    What we do support:
        - items
        - minItems
...
def gen_from_type(schema: dict[str, Any], *, property_name: str | None = None) -> Any:
    schema_type = schema.get("type")
...
def pick_sub_schema(
    schema: dict[str, Any], sub_schema_key: str, *, property_name: str | None = None
) -> Any:
...
def evaluate_all_of(schema: dict[str, Any], value: Any, *, property_name: str | None = None) -> Any:
...
def _generate_example(json_schema: dict[str, Any], *, property_name: str | None = None) -> Any:
    # Apply base schema
...
def generate_example(json_schema: dict[str, Any], *, property_name: str | None = None) -> Any:
